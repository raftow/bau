<?php
      ...
      if(($objme) and ($objme->isAdmin()))
      {
              ...
              $menu[$numtheme][$numsubtheme][$nummenu++] = array("page"=>"main.php?Main_Page=afw_mode_search.php&cl=Jobsdd", "png"=>"../images/profile.png", "titre"=>"الأدوار الوظيفية", "id"=>"", "class"=>"opened", "subtheme"=>2);
              ...
              $menu[$numtheme][$numsubtheme][$nummenu++] = array("page"=>"main.php?Main_Page=afw_mode_search.php&cl=Stakeholder", "png"=>"../images/schoolinfo.png", "titre"=>"الجهات المعنية", "id"=>"", "class"=>"opened", "subtheme"=>3);
              $numsubtheme++;
