...
class UserStory extends AFWObject
{
                        ...
                        if ($jobrole and $bfunction and $module) {
                                ...
                                if ((!$goal_id) and $bfunction->isEnumOrLookup()) {
                                        ...
                                        if ($goalLookup) {
                                                ...
                                                $goal_decision .= ' / lookup goal missed';
                                }
                                ...
                                if ((!$goal_id) and $bfunction->isStats()) {
                                        ...
                                        if ($goalStats) {
                                                ...
                                                $goal_decision .= ' / stats goal missed';
                                }
                                ...
                                if ($goal_id)
                                        $this->set('user_story_goal_id', $goal_id);
                                ...
                                if ($goal_id) {
                                        ...
                                        if (!$goal_decision)
                                                $goal_decision = "no goal found for the jobrole [$jobrole] and business function [$bfunction]";
                                        $err = $goal_decision;
                                        $info = '';
        ...
        public function beforeMAJ($id, $fields_updated)
        {
                ...
                if ($this->isActive()) {
                        ...
                        if ($jobrole and $bfunction and $module) {
                                ...
                                if ($this->getVal('user_story_name_ar') == '--')
                                        $this->set('user_story_name_ar', '');
                                if ($this->getVal('user_story_name_en') == '--')
                                        $this->set('user_story_name_en', '');
                                ...
                                if ($el_module) {
                                        ...
                                        if ($ar)
                                                $this->set('arole_id', $ar->getId());
                                        else
                                                $this->maj_code .= "<br>Arole::getAssociatedRoleForSubModule($module_id, $el_module) returned empty result ";
                                } else {
                                        if ((!$this->getVal('arole_id')) and $goal and ($goal->getId() > 0)) {
                                                ...
                                                if ($ar)
                                                        ...
                                                        $this->maj_code .= "<br>$goal : goal->getOrCreateAssociatedArole() returned empty result ";
                                        }
                                        ...
                                        if (!$this->getVal('arole_id')) {
                                                ...
                                                if (($count_aroles == 1) and $jobrole->isFinished()) {
                                                        ...
                                                        $this->maj_code .= "<br>$jobrole : jobrole->getRoles() count $count_aroles != 1 or jobrole not finished";
                                        }
                                }
                        } else
        ...
        protected function beforeSetAttribute($attribute, $newvalue)
        {
                ...
                if (($attribute == 'user_story_goal_id') and ($oldvalue != $newvalue) and ($newvalue > 0) and ($oldvalue > 0)) {
                        if ($this->getVal('source') == 'auto-generated')
                                $this->set('source', 'auto-generated-but-user-updated');
                }
